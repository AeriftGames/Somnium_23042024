...
public partial class CGlobalSettings : Node
{
    ...
    public void LoadAndApply_AllGraphicsSettings()
    {
        ...
        gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "all graphics data is apply");
    }
    ...
    public void SaveActual_AllGraphicsSettings()
    {
        ...
        gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "all graphics data is saved");
    }
    ...
    public void LoadAndApply_AllAudioSettings()
    {
        ...
        gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "all audio data is apply");
    }
    ...
    public void SaveActual_AllAudioSettings()
    {
        ...
        gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "all audio data is saved");
    }
    ...
    public void LoadAndApply_AllInputsSettings()
    {
        ...
        gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "all inputs data is apply");
    }
    ...
    public void SaveActual_AllInputsSettings()
    {
        ...
        gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "all inputs data is saved");
    }
    ...
    public void Apply_ScreenMode(int newScreenModeID, bool newApplyNow = false, bool newSaveNow = false)
    {
        ...
        if (newApplyNow)
        {
            if (newScreenModeID == 0)
            {
                ...
                CGameMaster.GM.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply video settings:" +
            ...
            else
            {
                ...
                CGameMaster.GM.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "pokus o chybne nastaveni screen mode id," +
        ...
        if (newSaveNow)
        {
            ...
            GetData().Save();
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "save video settings: screen mode id = " + newScreenModeID);
        }
    }
    ...
    public int GetActual_ScreenMode()
    {
        ...
        else
        {
            ...
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "chybne vraceni hodnoty z GetActual_ScreenMode," +
    ...
    public void Apply_ScreenSizeID(int newScreenSizeID, bool newApplyNow = false, bool newSaveNow = false)
    {
        ...
        if (newApplyNow)
        {
            if (newScreenSizeID == 0)
            {
                ...
                CGameMaster.GM.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply video settings: screen size id = 1280x720");
            ...
            else if (newScreenSizeID == 1)
            {
                ...
                //Apply_ScreenMode(GetActual_ScreenMode(), true, false);
                CGameMaster.GM.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply video settings: screen size id = 1920x1080");
            }
            else if (newScreenSizeID == 2)
            {
                ...
                //gm.GetTree().Root.Size = new Vector2i(DisplayServer.ScreenGetSize().x-1, DisplayServer.ScreenGetSize().y-1);
                CGameMaster.GM.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply video settings: screen size id = screen size");
            }
            else
            {
                //chyba - mimo rozsah id
                CGameMaster.GM.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "pokus o chybne nastaveni screen size id," +
        ...
        if (newSaveNow)
        {
            ...
            GetData().Save();
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "save video settings: screen size id = " + newScreenSizeID);
        }
    }
    ...
    public int GetActual_ScreenSizeID()
    {
        ...
        {
            //error - mimo rozsah id
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "chybne vraceni hodnoty z GetActual_ScreenSizeID," +
    ...
    public void Apply_GlobalIlumination(int newValue, bool newApplyNow = false, bool newSaveNow = false)
    {
        if (newApplyNow)
        {
            ...
            {
                // disable
                VoxelGI voxelGI = CGameMaster.GM.GetGame().GetLevelLoader().GetActualLevelScene().GetVoxelGI();
                if (voxelGI != null)
                    voxelGI.Visible = false;

                Apply_Sdfgi(false, true, false);
                gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply video settings: gi = " + newValue + "(disable)");
            }
            else if (newValue == 1)
            {
                // voxel
                ...
                //Apply_ScreenMode(0);
                //Apply_ScreenMode(a);
                gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply video settings: gi = " + newValue + "(voxel)");
            }
            else if (newValue == 2)
            {
                // sdfgi
                ...
                gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply video settings: gi = " + newValue + "(sdfgi)");
            }
        }
        ...
        if (newSaveNow)
        {
            ...
            GetData().Save();
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "save video settings: gi = " + newValue);
        }
    ...
    {
        // Apply now
        if (newApplyNow && CGameMaster.GM.GetGame().GetLevelLoader().GetActualLevelScene() != null)
        {
            Godot.Environment env =
                CGameMaster.GM.GetGame().GetLevelLoader().GetActualLevelScene().GetWorldEnvironment().Environment;

            env.SsaoEnabled = newValue;
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply video settings: ssao = " + newValue);
        }
        ...
        if (newSaveNow)
        {
            ...
            GetData().Save();
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "save video settings: ssao = " + newValue);
        }
    }
    ...
    public void Apply_Ssil(bool newValue, bool newApplyNow = false, bool newSaveNow = false)
    {
        ...
        if (newApplyNow && CGameMaster.GM.GetGame().GetLevelLoader().GetActualLevelScene() != null)
        {
            ...
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply video settings: ssil = " + newValue);
        }
        ...
        if (newSaveNow)
        {
            ...
            GetData().Save();
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "save video settings: ssil = " + newValue);
        }
    }
    ...
    private void Apply_Sdfgi(bool newValue, bool newApplyNow = false, bool newSaveNow = false)
    {
        ...
        if (newApplyNow && CGameMaster.GM.GetGame().GetLevelLoader().GetActualLevelScene() != null)
        {
            ...
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply video settings: sdfgi = " + newValue);
        }
        ...
        if (newSaveNow)
        {
            ...
            GetData().Save();
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "save video settings: sdfgi = " + newValue);
        }
    }
    ...
    public void Apply_UnlockMaxFps(bool newValue, bool newApplyNow = false, bool newSaveNow = false)
    {
        ...
        if (newApplyNow)
        {
            ...
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply video settings: unlock max fps = " + newValue);
        }
        ...
        if (newSaveNow)
        {
            ...
            GetData().Save();
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "save video settings: unlock max fps = " + newValue);
        }
    }
    ...
    public void Apply_DisableVsync(bool newValue, bool newApplyNow = false, bool newSaveNow = false)
    {
        ...
        if (newApplyNow)
        {
            ...
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply video settings: disable vsync = " + newValue);
        }
        ...
        if (newSaveNow)
        {
            //GetData().UnlockMaxFps = newValue;
            GetData().Save();
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "save video settings: disable vsync = " + newValue);
        }
    }
    ...
    public void Apply_AntialiasID(int newAntialiasID, bool newApplyNow = false, bool newSaveNow = false)
    {
        ...
        if (newApplyNow)
        {
            if (newAntialiasID == 0)
            {
                ...
                CGameMaster.GM.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply video settings: antialias id = disable");
            ...
            else if (newAntialiasID == 1)
            {
                ...
                gm.GetTree().Root.UseTaa = false;
                gm.GetTree().Root.Msaa3D = Viewport.Msaa.Disabled;
                CGameMaster.GM.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply video settings: antialias id = only ss_aa");
            }
            else if (newAntialiasID == 2)
            {
                ...
                gm.GetTree().Root.Msaa3D = Viewport.Msaa.Disabled;
                CGameMaster.GM.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply video settings: antialias id = ss_aa + taa");
            }
            else if (newAntialiasID == 3)
            {
                ...
                CGameMaster.GM.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply video settings: antialias id = only msaa3d_2x");
            }
            else if (newAntialiasID == 4)
            {
                ...
                gm.GetTree().Root.UseTaa = true;
                gm.GetTree().Root.Msaa3D = Viewport.Msaa.Msaa2X;
                CGameMaster.GM.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply video settings: antialias id = ss_aa + taa + msaa3d_2x");
            }
            else
            {
                //chyba - mimo rozsah id
                CGameMaster.GM.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "pokus o chybne nastaveni antialias id," +
        ...
        if (newSaveNow)
        {
            ...
            GetData().Save();
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "save video settings: antialias = " + newAntialiasID);
        }
    }
    ...
    public int GetActual_AntialiasID()
    {
        ...
        {
            //error - mimo rozsah id
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "chybne vraceni hodnoty z GetActual_AntialiasID," +
    ...
    public void Apply_Scale3D(float newValue, bool newApplyNow = false, bool newSaveNow = false)
    {
        ...
        if (newApplyNow)
        {
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply video settings: scale 3d = " + newValue);
        ...
        if (newSaveNow)
        {
            ...
            GetData().Save();
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "save video settings: scale 3d = " + newValue);
        }
    }
    ...
    public void Apply_HalfResolutionGI(bool newValue, bool newApplyNow = false, bool newSaveNow = false)
    {
        ...
        if (newApplyNow)
        {
            ...
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply video settings: half resolutoin gi = " + newValue);
        ...
        if (newSaveNow)
        {
            ...
            GetData().Save();
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "save video settings: half resolution gi = " + newValue);
        }
    }
    ...
    public void Apply_MainVolume(float newValue, bool newApplyNow = false, bool newSaveNow = false)
    {
        ...
        if (newApplyNow)
        {
            ...
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply audio settings: main volume = " + newValue);
        }
        ...
        if (newSaveNow)
        {
            ...
            GetData().Save();
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "save audio settings: main volume = " + newValue);
        }
    }
    ...
    public void Apply_SfxVolume(float newValue, bool newApplyNow = false, bool newSaveNow = false)
    {
        ...
        if (newApplyNow)
        {
            ...
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply audio settings: sfx volume = " + newValue);
        }
        ...
        if (newSaveNow)
        {
            ...
            GetData().Save();
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "save audio settings: sfx volume = " + newValue);
        }
    }
    ...
    public void Apply_MusicVolume(float newValue, bool newApplyNow = false, bool newSaveNow = false)
    {
        ...
        if (newApplyNow)
        {
            ...
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "apply audio settings: music volume = " + newValue);
        }
        ...
        if (newSaveNow)
        {
            ...
            GetData().Save();
            gm.GetUniversal().GetMasterLog().WriteLog(gm, CMasterLog.ELogMsgType.INFO, "save audio settings: music volume = " + newValue);
        }
    }
    ...
    public void Apply_LookMouseSmooth(float newValue, bool newApplyNow = false, bool newSaveNow = false)
    {
        ...
        if (newApplyNow)
        {
            ...
            CGameMaster.GM.GetGame().GetFPSCharacter().MouseSmooth = newValue;
        }
    ...
    {
        if (CGameMaster.GM.GetGame().GetFPSCharacter() == null) return 1f;
        return CGameMaster.GM.GetGame().GetFPSCharacter().MouseSmooth;
    }
    ...
    public void Apply_LookMouseSensitivity(float newValue, bool newApplyNow = false, bool newSaveNow = false)
    {
        ...
        {
            if (CGameMaster.GM.GetGame().GetFPSCharacter() == null) return;
            CGameMaster.GM.GetGame().GetFPSCharacter().MouseSensitivity = newValue;
        }
    ...
    {
        if (CGameMaster.GM.GetGame().GetFPSCharacter() == null) return 1f;
        return CGameMaster.GM.GetGame().GetFPSCharacter().MouseSensitivity;
    }
    ...
    public void Apply_LookGamepadSmooth(float newValue, bool newApplyNow = false, bool newSaveNow = false)
    {
        ...
        {
            if (CGameMaster.GM.GetGame().GetFPSCharacter() == null) return;
            CGameMaster.GM.GetGame().GetFPSCharacter().GamepadSmooth = newValue;
        }
    ...
    {
        if (CGameMaster.GM.GetGame().GetFPSCharacter() == null) return 1f;
        return CGameMaster.GM.GetGame().GetFPSCharacter().GamepadSmooth;
    }
    ...
    public void Apply_LookGamepadSensitivity(float newValue, bool newApplyNow = false, bool newSaveNow = false)
    {
        ...
        {
            if (CGameMaster.GM.GetGame().GetFPSCharacter() == null) return;
            CGameMaster.GM.GetGame().GetFPSCharacter().GamepadSensitvity = newValue;
        }
    ...
    {
        if (CGameMaster.GM.GetGame().GetFPSCharacter() == null) return 1f;
        return CGameMaster.GM.GetGame().GetFPSCharacter().GamepadSensitvity;
    }
    ...
    public void Apply_InverseVerticalLook(bool newValue, bool newApplyNow = false, bool newSaveNow = false)
    {
        ...
        {
            if (CGameMaster.GM.GetGame().GetFPSCharacter() == null) return;
            CGameMaster.GM.GetGame().GetFPSCharacter().InverseVerticalLook = newValue;
        }
    ...
    {
        if (CGameMaster.GM.GetGame().GetFPSCharacter() == null) return false;
        return CGameMaster.GM.GetGame().GetFPSCharacter().InverseVerticalLook;
    }
