...
public partial class dead_cam_body : RigidBody3D
{
    ...
    public override void _PhysicsProcess(double delta)
    {
        ...
        {
            // lerp pos of camera
            CGameMaster.GM.GetGame().GetFPSCharacterOld().GetFPSCharacterCamera().GlobalPosition = 
                CGameMaster.GM.GetGame().GetFPSCharacterOld().GetFPSCharacterCamera().
    ...
    {
        Camera3D characterCamera = CGameMaster.GM.GetGame().GetFPSCharacterOld().GetFPSCharacterCamera();
        Vector3 oldGlobalPosition = characterCamera.GlobalPosition;
        Vector3 oldDirectionPoint = CGameMaster.GM.GetGame().GetFPSCharacterOld().GlobalPosition + 
        ...
        CGameMaster.GM.GetGame().GetFPSCharacterOld().GetObjectCamera().SetLerpToCharacterEnable(false);
    ...
    public void _on_body_entered(Node body)
    {
        ...
        FPSCharacter_Inventory char_inv = CGameMaster.GM.GetGame().GetFPSCharacterOld() as FPSCharacter_Inventory;
