...
public partial class poklop_physics : Node3D
{
	...
	{
		interactiveObject = GetNode<interactive_object>("RigidBody3D_Poklop/interactive_object");

		wardrobeDoorGrab = GetNode<RigidBody3D>("RigidBody3D_Poklop");
